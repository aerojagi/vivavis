...
# -Erstellung   jko 2025-08-12  V2.0
# -Änderungen   V1.0  Erstversion zur automatisierten Stichwortsuche in Blogs
...
# Zu suchende Stichwörter
keywords = ["Cisco", "vulnerability", "exploit", "malware", "zero-day", "threat", "Active Directory"]
